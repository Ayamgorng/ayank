...
console.log(color(figlet.textSync('ArzanOffc', {
		font: 'Small',
	...
	console.log(color(`${spc2}           [ Created by: ArzanOffc ]` ,`${randomcolor}`))
...
if(usePairingCode && !zyko.authState.creds.registered) {
		const phoneNumber = await question('Masukan Nomer Yang Aktif Awali Dengan 62 Recode : ArzanOffc:\n');
